      ...
      <div class="modal fade" id="Add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index:99999;">
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content">
            ...
            <form class="afterSubmitForm" action="{{url('sliders')}}" method="post" enctype="multipart/form-data"> @csrf
          ...
          <table class="table table-responsive table-striped table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="nowrap"><img style="height:60px;width:auto;" src="{{asset('images/sliders/'.$data->image)}}" alt="{{$data->title}}"></td>
                <td class="nowrap">
              ...
              <div class="modal fade" id="Edit{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index:99999;">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <form class="afterSubmitForm2" action="{{url('sliders/'.$data->id)}}" method="post" enctype="multipart/form-data"> @csrf @method('put')
                    <div class="modal-body">
                      <div class="row">
                          ...
                          <div class="col-12 mb-3">
                              <label for="image">Image <span class="text-danger fw-bold">*</span></label>
                              <img style="height:100px;width:auto;" src="{{asset('images/sliders/'.$data->image)}}" alt="{{$data->title}}">
              ...
              <div class="modal fade" id="Delete{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index:99999;">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <form class="afterSubmitForm3" action="{{url('sliders/'.$data->id)}}" method="post" enctype="multipart/form-data"> @csrf @method('delete')
