    ...
    <div class="key_highlight">
      <div class="">
        <div class="key_highlight_sec_img">
          <img src="{{asset('assets/images/uploads/services/1741029252_S2ih60RSHO.png')}}" class="img-fluid" alt="img">
        </div>
      </div>
      <div class="">
        <div class="key_highlight_sec_text">
          <h1>Cloud Services</h1>
          <p>With a focus on cloud-first strategies, Kloud Technologies provides secure and scalable cloud services:
...
4. Cloud Security: Implementing robust security measures to protect cloud assets.</p>
        </div>
                  <div class="key_highlight_sec_text">
            <h5></h5>
            <p></p>
