    ...
    <div class="key_highlight">
      <div class="">
        <div class="key_highlight_sec_img">
          <img src="{{asset('assets/images/uploads/services/1740551539_SsvwfH6cT6.jpg')}}" class="img-fluid" alt="img">
        </div>
      </div>
      <div class="">
        <div class="key_highlight_sec_text">
          <h1>Consumer Electronics &amp; Smart Devices</h1>
          <p>Enhancing digital lifestyles with:

1. Smart Home Solutions: IoT-based home automation systems.

2. Smart Devices: Phones, tablets, and wearables.

3. Audio &amp; Visual Equipment: High-quality projectors, speakers, and home theater systems.</p>
        </div>
                  <div class="key_highlight_sec_text">
            <h5></h5>
            <p></p>
