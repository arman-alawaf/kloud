    ...
    <div class="key_highlight">
      <div class="">
        <div class="key_highlight_sec_img">
          <img src="{{asset('assets/images/uploads/services/1740550328_n5bnd4799O.jpg')}}" class="img-fluid" alt="img">
        </div>
      </div>
      <div class="">
        <div class="key_highlight_sec_text">
          <h1>Enterprise Solutions</h1>
          <p>Kloud Technologies provides robust enterprise IT solutions, including:
...
5. Customer Relationship Management (CRM): Enhancing customer interactions and sales management.</p>
        </div>
                  <div class="key_highlight_sec_text">
            <h5></h5>
            <p></p>
