...
@section('content')
  ...
  <div class="banner_text">
      <img src="{{asset('assets/include/img/about_banner.html')}}" class="img-fluid" alt="img">
    ...
    <div class="key_highlight">
      ...
      <div class="">
        <div class="key_highlight_sec_text">
          ...
          <p>Kloud Technologies provides enterprise-grade infrastructure solutions to support businesses with scalable and reliable IT environments.
...
5. Virtualization &amp; Cloud Solutions: Enabling businesses to optimize resources and increase efficiency through virtualization and cloud-based solutions.</p>
        </div>
                  <div class="key_highlight_sec_text">
            <h5></h5>
            <p></p>
