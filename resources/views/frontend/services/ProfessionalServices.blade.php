    ...
    <div class="key_highlight">
      <div class="">
        <div class="key_highlight_sec_img">
          <img src="{{asset('assets/images/uploads/services/1740551658_jZkM0cZnJe.jpg')}}" class="img-fluid" alt="img">
        </div>
      </div>
      <div class="">
        <div class="key_highlight_sec_text">
          <h1>Professional Services</h1>
          <p>Expert IT support and consulting, including:
...
3. Managed Services: Ongoing IT support and infrastructure maintenance.</p>
        </div>
                  <div class="key_highlight_sec_text">
            <h5></h5>
            <p></p>
