    ...
    <div class="key_highlight">
      <div class="">
        <div class="key_highlight_sec_img">
          <img src="{{asset('assets/images/uploads/services/1740550079_YWyEoXNZcm.jpg')}}" class="img-fluid" alt="img">
        </div>
      </div>
      <div class="">
        <div class="key_highlight_sec_text">
          <h1>Security Solutions</h1>
          <p>Kloud Technologies offers advanced security solutions to safeguard businesses from cyber threats:
...
6. Biometric Systems: Access control and attendance tracking using biometric authentication.</p>
        </div>
                  <div class="key_highlight_sec_text">
            <h5></h5>
            <p></p>
