    ...
    <div class="key_highlight">
      <div class="">
        <div class="key_highlight_sec_img">
          <img src="{{asset('assets/images/uploads/services/1740551289_sMClaMUWfg.jpg')}}" class="img-fluid" alt="img">
        </div>
      </div>
      <div class="">
        <div class="key_highlight_sec_text">
          <h1>Software Solutions</h1>
          <p>Providing essential software tools for productivity and efficiency:
...
4. Design &amp; Creativity Software: Adobe, Autodesk, and other industry-leading creative tools.</p>
        </div>
                  <div class="key_highlight_sec_text">
            <h5></h5>
            <p></p>
