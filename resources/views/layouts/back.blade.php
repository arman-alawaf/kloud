        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse justify-content-end header_menu_list" id="navbarNavDropdown">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link {{ request()->is('packages') || request()->is('packages-trash-list') ? 'active' : '' }}" href="{{url('packages')}}">Packages</a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ request()->is('orders') ? 'active' : '' }}" href="{{url('orders')}}">Orders</a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ request()->is('contacts') ? 'active' : '' }}" href="{{url('contacts')}}">Contacts</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item dropdown">
                  <a id="navbarDropdown" class="nav-link dropdown-toggle {{ request()->is('facebook-pixel') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                      {{ Auth::user()->name }}
                  </a>

                  <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                      @if(Auth::user()->type=='Admin')
                      <a class="dropdown-item {{ request()->is('apps') ? 'active' : '' }}" href="#" > {{ __('Settings') }} </a>
                      <a class="dropdown-item {{ request()->is('facebook-pixel') ? 'active' : '' }}" href="{{ url('facebook-pixel') }}" > {{ __('Facebook Pixel') }} </a>
                      @endif
